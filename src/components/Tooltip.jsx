      ...
      <div style={STYLE} className='Tooltip'>
        <div className='Separator'>
          <div className='TooltipTop'>
            ...
            <div className='itemrow white'>{props.item.preview_item.binding ? props.item.preview_item.binding.name : ""}</div>
            {/*start of uniqueness */}
            <div className='itemrow white'>{props.item.preview_item.unique_equipped ? props.item.preview_item.unique_equipped : ""}</div>
            {/*start of armor type */}
            <div className='itemrow white'>
              ...
              <div>
                ...
                {(props.item.preview_item.inventory_type.name !== "Back" && props.item.preview_item.inventory_type.name !== "Trinket" && props.item.preview_item.inventory_type.name !== "Finger" && props.item.preview_item.inventory_type.name !== "Tabard" && props.item.preview_item.inventory_type.name !== "Neck" && props.item.preview_item.inventory_type.name !== "Shirt" && props.item.preview_item.inventory_type.name !== "Thrown") ? props.item.preview_item.item_subclass.name : ""}
              </div>
            </div>
            ...
            {/*armor stat */}
            <div className='itemrow white'>{props.item.preview_item.armor ? props.item.preview_item.armor.display.display_string : ""}</div>
            {/*start of +xyz stats */}

    ...
    <div id={`${ach.id}`} className="Achievement">
      ...
      <div className="AchData">
        ...
        <div className="AchNameDesc">
          <div>
            <div className="AchName">{ach.name}</div>
          </div>
          <div className="AchDesc">{ach.description}</div>
          <div className="RewardText">{ach.reward_text}</div>
        </div>
            ...
            <div className="AchShield">
              {!ach.is_statistic && ach.points === 0 ? (
                <div>
                  ...
                  <div className="Date feat">{date}</div>
                </div>
              ) : (
                <div>
                  <img src={require(`../../images/Achievement/Achievement_icon.webp`)} />
                  <div className="Points">{ach.points}</div>
  ...
  props.achievement.category &&
    ...
    <div id={`${ach.id}`} className="Achievement notEarned">
      ...
      <div className="AchData">
        ...
        <div className="AchNameDesc">
          <div>
            <div className="AchName NotEarned">{ach.name}</div>
          </div>
          <div className="AchDesc">{ach.description}</div>
          <div className="RewardText NotEarned">{ach.reward_text}</div>
        </div>
        <div className="AchPointsDate">
          <div>
